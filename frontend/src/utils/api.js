...
export const recordingsAPI = {
  ...
  getUrl:       (filename)  => `http://localhost:5000/uploads/${filename}`,
};
...
export const companiesAPI = {
  ...
  // FIX: Added 'data' parameter and spread it into the request body
  // This allows { sessionId, elapsed: number } to be sent to the backend
  endSession:   (id, sessionId, data) => API.post(`/companies/${id}/session/end`, { 
    sessionId, 
    ...data 
  }),
};
